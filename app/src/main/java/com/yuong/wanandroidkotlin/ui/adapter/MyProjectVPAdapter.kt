...
import com.yuong.wanandroidkotlin.ui.project.ui.ProjectDetailFragment
import com.yuong.wanandroidkotlin.ui.wechat.ui.WxArticleFragment

class MyProjectVPAdapter(fm: FragmentManager?) : FragmentPagerAdapter(fm) {
    private var titles: MutableList<String>
    private lateinit var datas: List<ProjectCategoryBean.DataBean>

    init {
        titles = ArrayList()
    }

    fun setList(datas: List<ProjectCategoryBean.DataBean>) {
        this.datas = datas
        this.titles.clear()
