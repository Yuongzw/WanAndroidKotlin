...
import com.yuong.wanandroidkotlin.util.SizeUtils
...
class SmoothCheckBox : View, Checkable {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, SizeUtils.dip2px(MyApplication.context!!, 0F))
        ta.recycle()
    ...
    private fun measureSize(measureSpec: Int): Int {
        val defSize = SizeUtils.dip2px(MyApplication.context!!, DEF_DRAW_SIZE.toFloat())
